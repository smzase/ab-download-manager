            ...
            describe = {
                when (it.proxyMode) {
                    ...
                    ProxyMode.CloudflareWorker -> {
                        Res.string.settings_use_proxy_describe_cloudflare_worker
                            .asStringSourceWithARgs(
                                Res.string.settings_use_proxy_describe_cloudflare_worker_createArgs(
                                    value = it.cloudflareWorker.workerUrl
                                )
                            )
                    }
                }
